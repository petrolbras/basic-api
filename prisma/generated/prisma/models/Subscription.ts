...
export type SubscriptionWhereInput = {
  ...
  frequency?: Prisma.EnumFrequencyFilter<"Subscription"> | $Enums.Frequency
  category?: Prisma.EnumCategoryFilter<"Subscription"> | $Enums.Category
...
export type SubscriptionScalarWhereWithAggregatesInput = {
  ...
  frequency?: Prisma.EnumFrequencyWithAggregatesFilter<"Subscription"> | $Enums.Frequency
  category?: Prisma.EnumCategoryWithAggregatesFilter<"Subscription"> | $Enums.Category
...
export type SubscriptionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"name" | "id" | "price" | "currency" | "frequency" | "category" | "paymentMethod" | "status" | "startDate" | "renewalDate" | "userId" | "createdAt", ExtArgs["result"]["subscription"]>
...
export interface SubscriptionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const subscriptionWithNameOnly = await prisma.subscription.findMany({ select: { name: true } })
   * 
   */
   ...
   * const subscriptionWithNameOnly = await prisma.subscription.createManyAndReturn({
   *   select: { name: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const subscriptionWithNameOnly = await prisma.subscription.updateManyAndReturn({
   *   select: { name: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SubscriptionFieldRefs {
  ...
  readonly frequency: Prisma.FieldRef<"Subscription", 'Frequency'>
  readonly category: Prisma.FieldRef<"Subscription", 'Category'>
